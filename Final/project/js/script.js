...
let getArtists = () => {
  ...
  else if (status !== "" && !categoryId && !basePrice && !name) {
      ...
      artists.forEach(artist => {
        ...
        <div class="artist-card">
          ...
          <div class="artist-info">
            ...
            <button><a href="/artist_details?id=${artist.ArtistID}" class="view-button">View Details</a></button>
          </div>
        </div>`;
      });
...
async function convertToTHB() {
  ...
  // Get the base price and remove any non-numeric characters except decimal point
  ...
  try {
    // Replace YOUR_API_KEY with your actual API key from freecurrencyapi.com
    ...
    if (data && data.data && data.data.THB) {
      ...
      // Format to 2 decimal places and show result
          ...
          artists.forEach(artist => {
            ...
            <div class="col-md-4">
              <div class="card-h-100">
                <img src="${artist.PhotoPath || '/image/Product_img/User.png'}" class="card-image-fixed" 
                     onerror="this.src='/image/Product_img/User.png'">
                <div class="card-text-container">
                  <p class="preahvihear" style="margin-top: 15px;">${artist.ArtistName}</p>
                  <p class="preahvihear" style="margin-top: 15px;">${artist.AboutMe || 'No description available.'}<br><br>From US$${artist.BasePrice}</p>
